...
const CARD: CompanyCardData = { id: 1, name: "한국첨단소재", industry: "소재", businessNo: "1", headcount: { latest: 40, delta12m: -0.1 }, latestArticle: "2026-08-28T00:00:00.000Z", events30d: { alert: 0, notice: 1, positive: 0, info: 0 }, open: 1, worstSeverity: "notice", trust: "needs_review", needsReview: false, everHadEvents: true };
